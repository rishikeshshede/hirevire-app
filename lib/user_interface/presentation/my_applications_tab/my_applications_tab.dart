                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextField(
                            readOnly: true,
                            controller:
                                myApplicationsController.filterController,
                        ...
                        Obx(() {
                          return myApplicationsController
                                  .myApplications.value.isEmpty
                              ? Expanded(
                                  child: const Center(
                                    child:
                                        Text('No job applications available'),
                                  ),
                                )
                              : Padding(
                                  padding: const EdgeInsets.symmetric(
