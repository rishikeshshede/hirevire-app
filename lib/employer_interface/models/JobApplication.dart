...
class JobApplication {
  ...
  factory JobApplication.fromJson(Map<String, dynamic> json) {
    return JobApplication(
      id: json['_id'],
      jobPostId: json['jobPostId'] != null ? JobPostId.fromJson(json['jobPostId']) : null,
      appliedBy: json['appliedBy'] != null ? AppliedBy.fromJson(json['appliedBy']) : null,
      media: json['media'] != null ? List<Media>.from(json['media'].map((x) => Media.fromJson(x))) : null,
      answers: json['answers'] != null ? List<Answer>.from(json['answers'].map((x) => Answer.fromJson(x))) : null,
      status: json['status'],
      requiredSkills: json['requiredSkills'] != null ? List<RequiredSkill>.from(json['requiredSkills'].map((x) => RequiredSkill.fromJson(x))) : null,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'answers': answers != null ? List<dynamic>.from(answers!.map((x) => x.toMap())) : null,
      'status': status,
...
class JobPostId {
  ...
  factory JobPostId.fromJson(Map<String, dynamic> json) {
    return JobPostId(
      ...
      jobRequisition: json['jobRequisition'] != null ? JobRequisition.fromJson(json['jobRequisition']) : null,
      title: json['title'],
      department: json['department'],
      project: json['project'],
      jobMode: json['jobMode'] != null ? List<String>.from(json['jobMode']) : null,
      description: json['description'],
      ctc: json['ctc'],
      status: json['status'],
      questions: json['questions'] != null ? List<Question>.from(json['questions'].map((x) => Question.fromJson(x))) : null,
      growthPlan: json['growth_plan'] != null ? List<GrowthPlan>.from(json['growth_plan'].map((x) => GrowthPlan.fromJson(x))) : null,
      perks: json['perks'],
      requiredSkills: json['requiredSkills'] != null ? List<RequiredSkill>.from(json['requiredSkills'].map((x) => RequiredSkill.fromJson(x))) : null,
      media: json['media'] != null ? List<Media>.from(json['media'].map((x) => Media.fromJson(x))) : null,
      endsOn: json['endsOn'] != null ? DateTime.parse(json['endsOn']) : null,
      savedApplications: json['savedApplications'] != null ? List<String>.from(json['savedApplications']) : null,
      createdAt: json['createdAt'] != null ? DateTime.parse(json['createdAt']) : null,
      updatedAt: json['updatedAt'] != null ? DateTime.parse(json['updatedAt']) : null,
      v: json['__v'],
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'growth_plan': growthPlan != null ? List<dynamic>.from(growthPlan!.map((x) => x.toMap())) : null,
      'perks': perks,
      'requiredSkills': requiredSkills != null ? List<dynamic>.from(requiredSkills!.map((x) => x.toMap())) : null,
      'media': media != null ? List<dynamic>.from(media!.map((x) => x.toMap())) : null,
...
class PostedBy {
  ...
  PostedBy({this.id, this.name, this.description, this.officialEmail, this.industry, this.socialUrls});
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'industry': industry,
      'socialUrls': socialUrls != null ? List<dynamic>.from(socialUrls!.map((x) => x.toMap())) : null,
    };
  }
}
...
class AppliedBy {
  ...
  AppliedBy({this.id, this.name, this.email, this.profilePicUrl});
