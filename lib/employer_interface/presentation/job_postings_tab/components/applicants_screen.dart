...
class ApplicantsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PaddedContainer(
      ...
      vPadding: 4.h(context),
      hPadding: 8.w(context),
      child: Obx(
        () {
                      ...
                      children: [
                        Expanded(
                          child: Center(
                            child: CardSwiper(
                              cardsCount:
                                  viewApplicantsController.jobApplicant.length,
                              cardBuilder: (context, index, percentThresholdX,
                                  percentThresholdY) {
                                final job = viewApplicantsController
                                    .jobApplicant[index];
                              ...
                              onSwipe: (index, percentThresholdX, direction) {
                                if (direction == CardSwiperDirection.right) {
                                  viewApplicantsController.shortListApplicant(
                                      viewApplicantsController
                                          .jobApplicant[index]);
                                } else if (direction ==
                                    CardSwiperDirection.left) {
                                  viewApplicantsController.rejectApplicant(
                                      viewApplicantsController
                                          .jobApplicant[index]);
                                }
